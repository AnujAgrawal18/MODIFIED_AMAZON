...
export const ProductInputSchema = z.object({
  ...
  manufacturerimages: z.array(z.string()).min(1, 'Product must have at least one image'),
  sellerimages: z.array(z.string()).min(1, 'Product must have at least one image'),
...
export const CartSchema = z.object({
  ...
  returnOption : z.optional(z.string()),
